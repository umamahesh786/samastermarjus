 ...
 */
public class GlassComparator
	extends DrinkComparator
{
	public int compare(Object o1, Object o2)
	{
		return ((Drink)o1).getGlassType().compareTo(((Drink)o2).getGlassType());
	}
	 ...
	 * the name of the glass type if the drink for true to be returned.
	 * This may be changed at a later date to handle regular expressions.
	 *
	 */
	public boolean equals(Drink d, Object val)
	{
		//return d.getGlassType().equals(val);
		return stringsCompare((String)val, d.getGlassType());
	}
