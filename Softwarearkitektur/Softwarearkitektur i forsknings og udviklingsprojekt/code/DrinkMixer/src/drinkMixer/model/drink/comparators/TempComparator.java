	...
	extends DrinkComparator
{
	...
	{
		return ((Drink)o1).getTemp().compareTo(((Drink)o2).getTemp());
	}
	 ...
	 * the temperature field of the drink for true to be returned.
	 * This may be changed at a later date to handle regular expressions.
	 *
	 */
	public boolean equals(Drink d, Object val)
	{
		//return d.getTemp().equals(val);
		return stringsCompare((String)val, d.getTemp());
	}
